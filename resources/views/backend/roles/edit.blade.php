...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        <h1 class="h3 mb-1 text-gray-800 font-weight-bold"><i class="fas fa-edit text-primary mr-2"></i>Edit Role & Permissions</h1>
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 16px;">
        ...
        <div class="card-body p-4">
            <div class="form-group mb-0">
                ...
                <input type="text" name="name" value="{{ old('name', $role->name) }}" class="form-control form-control-custom @error('name') is-invalid @enderror" required>
            </div>
        </div>
    </div>
