...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-1 text-gray-800 font-weight-bold"><i class="fas fa-plus-circle text-primary mr-2"></i>Create New
                Role & Assign Permissions</h1>
            ...
            <div class="card-body p-4">
                <div class="form-group mb-0">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                        ...
                        placeholder="e.g. competition-manager" required>
                </div>
            </div>
        </div>
