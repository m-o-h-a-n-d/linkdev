...
@section('content')
    ...
    <div class="card mb-4" style="border-radius: 16px;">
        <div class="card-header py-3 d-flex justify-content-between align-items-center"
            ...
            <h6 class="m-0 font-weight-bold text-gray-800"><i class="fas fa-user-shield text-primary mr-2"></i>System Roles
                Table</h6>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="d-flex flex-wrap align-items-center">
                                        ...
                                        @empty
                                            <span class="badge badge-secondary py-1 px-3" style="border-radius: 12px;">No
