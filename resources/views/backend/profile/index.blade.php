...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="{{ route('admin.dashboard.index') }}" class="btn btn-outline-secondary btn-sm rounded-pill font-weight-bold px-3">
    ...
    <div class="col-lg-4 mb-4">
        <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 16px;">
            ...
            <div class="text-center" style="margin-top: -50px;">
                ...
                <div class="p-3">
                    <h5 class="font-weight-bold text-dark mb-1" id="previewName">{{ $admin?->name ?? 'Enter Full Name' }}</h5>
                    ...
                    <div class="text-left small">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-7 text-dark font-weight-bold" id="previewInfoName">: {{ $admin?->name ?? 'Enter Full Name' }}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5 font-weight-bold text-muted">Email</div>
                            <div class="col-7 text-dark" id="previewInfoEmail" style="word-break: break-all;">: {{ $admin?->email ?? 'email@example.com' }}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5 font-weight-bold text-muted">Phone</div>
                            <div class="col-7 text-dark" id="previewInfoPhone">: {{ $admin?->admin?->phone ?? '(---) --- ---' }}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5 font-weight-bold text-muted">National ID</div>
                            <div class="col-7 text-dark" id="previewInfoNationalId">: {{ $admin?->admin?->national_id ?? '-----------' }}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5 font-weight-bold text-muted">Gender</div>
                            <div class="col-7 text-dark" id="previewInfoGender">: {{ $admin?->admin?->gender ?? 'Not Selected' }}</div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-7 text-dark" id="previewInfoAddress">: {{ $admin?->admin?->address ?? '-----------' }}</div>
                        </div>
                    </div>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
            <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                <ul class="nav profile-nav-tabs" id="profileTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="edit-profile-tab" data-toggle="tab" href="#editProfile" role="tab">My Profile Settings</a>
                    </li>
                </ul>
            </div>
                        ...
                        <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" id="editProfileForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-custom @error('name') is-invalid @enderror" id="editName" value="{{ old('name', $admin?->name) }}" placeholder="e.g. John Doe" required>
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control form-control-custom @error('email') is-invalid @enderror" id="editEmail" value="{{ old('email', $admin?->email) }}" placeholder="e.g. john@example.com" required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control form-control-custom @error('phone') is-invalid @enderror" id="editPhone" value="{{ old('phone', $admin?->admin?->phone) }}" placeholder="e.g. +1234567890" required>
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="national_id" class="form-control form-control-custom @error('national_id') is-invalid @enderror" id="editNationalId" value="{{ old('national_id', $admin?->admin?->national_id) }}" placeholder="e.g. 12345678901234" required>
                                    @error('national_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="address" class="form-control form-control-custom @error('address') is-invalid @enderror" id="editAddress" value="{{ old('address', $admin?->admin?->address) }}" placeholder="e.g. 123 Main St, City" required>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="editPassword" class="font-weight-bold small text-gray-700">New Password <span class="text-muted font-weight-normal">(Leave blank to keep current)</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="password" name="password_confirmation" class="form-control form-control-custom" id="editPasswordConfirmation" placeholder="Re-enter password">
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('admin.dashboard.index') }}" class="btn btn-light rounded-pill px-4 mr-2 font-weight-bold">Cancel</a>
