        ...
        <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 16px;">
            ...
            <div class="text-center" style="margin-top: -50px;">
                <div class="d-inline-block position-relative">
                    <div id="previewAvatarBox" class="admin-avatar-placeholder mx-auto overflow-hidden d-flex align-items-center justify-content-center" style="width: 100px; height: 100px; border-radius: 50%; border: 4px solid #fff; background: #f1f5f9;">
                        <i class="fas fa-user fa-2x text-secondary" id="previewPlaceholderIcon"></i>
                        <img id="previewImageTag" src="" alt="Avatar Preview" class="w-100 h-100 d-none" style="object-fit: cover;">
                    </div>
                </div>
                <div class="p-3">
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
            <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                <ul class="nav profile-nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#createProfileTab" role="tab">New Admin Registration</a>
                    </li>
                </ul>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('admin.admins.store') }}" method="POST" enctype="multipart/form-data" id="createAdminForm">
                    @csrf
                    ...
                    <div class="mb-4 text-center text-md-left">
                        ...
                        <div class="d-inline-flex align-items-center">
                            <div class="avatar-upload-container mr-3 position-relative">
                                <div class="avatar-upload-circle overflow-hidden d-flex align-items-center justify-content-center" id="formAvatarCircle" style="width: 80px; height: 80px; border-radius: 50%; background: #f8fafc; border: 2px dashed #cbd5e1;">
                                    <i class="fas fa-user fa-2x text-gray-400" id="formPlaceholderIcon"></i>
                                    <img id="formImageTag" src="" alt="Avatar" class="w-100 h-100 d-none" style="object-fit: cover;">
                                </div>
                                <label for="imageUploadInput" class="avatar-upload-icon m-0 position-absolute" style="bottom: 0; right: 0; background: #ea580c; color: white; width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer;" title="Upload Photo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="inputName" class="font-weight-bold small text-gray-700">Full Name <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control form-control-custom @error('name') is-invalid @enderror" id="inputName" value="{{ old('name') }}" placeholder="e.g. John Doe" required>
                            @error('name')
                        ...
                        <!-- Email Address -->
                        <div class="col-md-6 mb-3">
                            <label for="inputEmail" class="font-weight-bold small text-gray-700">Email Address <span class="text-danger">*</span></label>
                            <input type="email" name="email" class="form-control form-control-custom @error('email') is-invalid @enderror" id="inputEmail" value="{{ old('email') }}" placeholder="e.g. john@example.com" required>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Password -->
                        <div class="col-md-6 mb-3">
                            <label for="inputPassword" class="font-weight-bold small text-gray-700">Password <span class="text-danger">*</span></label>
                            <input type="password" name="password" class="form-control form-control-custom @error('password') is-invalid @enderror" id="inputPassword" placeholder="Minimum 8 characters" required>
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="inputPasswordConfirmation" class="font-weight-bold small text-gray-700">Confirm Password <span class="text-danger">*</span></label>
                            <input type="password" name="password_confirmation" class="form-control form-control-custom" id="inputPasswordConfirmation" placeholder="Re-enter password" required>
                        </div>

                        <!-- Phone Number -->
                        <div class="col-md-6 mb-3">
                            <label for="inputPhone" class="font-weight-bold small text-gray-700">Phone Number <span class="text-danger">*</span></label>
                            <input type="text" name="phone" class="form-control form-control-custom @error('phone') is-invalid @enderror" id="inputPhone" value="{{ old('phone') }}" placeholder="e.g. +1234567890" required>
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- National ID -->
                        <div class="col-md-6 mb-3">
                            <label for="inputNationalId" class="font-weight-bold small text-gray-700">National ID <span class="text-danger">*</span></label>
                            <input type="number" name="national_id" class="form-control form-control-custom @error('national_id') is-invalid @enderror" id="inputNationalId" value="{{ old('national_id') }}" placeholder="e.g. 12345678901234" required>
                            @error('national_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Gender -->
                        <div class="col-md-6 mb-3">
                            <label for="inputGender" class="font-weight-bold small text-gray-700">Gender <span class="text-danger">*</span></label>
                            <select name="gender" class="form-control form-control-custom @error('gender') is-invalid @enderror" id="inputGender" required>
                        ...
                        <!-- Status -->
                        <div class="col-md-6 mb-3">
                            <label for="inputStatus" class="font-weight-bold small text-gray-700">Status <span class="text-danger">*</span></label>
                            <select name="status" class="form-control form-control-custom @error('status') is-invalid @enderror" id="inputStatus" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="role" class="form-control form-control-custom @error('role') is-invalid @enderror" id="inputRole">
                        ...
                        <!-- Address -->
                        <div class="col-md-6 mb-3">
                            <label for="inputAddress" class="font-weight-bold small text-gray-700">Address <span class="text-danger">*</span></label>
                            <input type="text" name="address" class="form-control form-control-custom @error('address') is-invalid @enderror" id="inputAddress" value="{{ old('address') }}" placeholder="e.g. 123 Main St, City" required>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePreview() {
        ...
        if (inputStatus) {
            previewInfoStatus.textContent = ': ' + (inputStatus.value ? inputStatus.value.charAt(0).toUpperCase() + inputStatus.value.slice(1) : 'Active');
        }
        if (inputRole) {
