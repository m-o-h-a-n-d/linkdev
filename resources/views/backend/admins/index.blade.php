    ...
    <div class="card-body p-3">
        <div class="row align-items-center">
            <div class="col-md-3 d-flex align-items-center mb-2 mb-md-0">
                ...
                <span class="badge badge-primary font-weight-bold px-3 py-2" style="border-radius: 8px;">{{ $admins->total() }} Admins</span>
            </div>
            <div class="col-md-9">
                <div class="input-group">
                    <input type="text" class="form-control border-0 bg-light small" placeholder="Search admins..." style="border-radius: 20px 0 0 20px; padding-left: 20px;" data-handball-search="adminCardsGrid">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="admin-card">
                <div class="admin-card-header {{ $gradientClass }}">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in">
                            <a class="dropdown-item" href="{{ route('admin.admins.show', $admin->id) }}"><i class="fas fa-user text-primary mr-2"></i>View Profile</a>
                            <a class="dropdown-item" href="{{ route('admin.admins.edit', $admin->id) }}"><i class="fas fa-edit text-warning mr-2"></i>Edit Profile</a>
                ...
                <div class="admin-avatar-wrapper">
                    <img src="{{ $avatarUrl }}" alt="{{ $admin->name }}" class="admin-avatar-circle" style="object-fit: cover;">
                </div>
                <div class="admin-card-body">
                    ...
                    <div class="admin-info-pill-box">
                        ...
                        <div class="admin-info-col">
                            <div class="admin-info-label text-truncate">{{ $admin->roles->first()?->name ? ucfirst($admin->roles->first()->name) : 'Admin' }}</div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm text-center p-5" style="border-radius: 16px;">
                <div class="py-4">
                    ...
                    <a href="{{ route('admin.admins.create') }}" class="btn btn-primary font-weight-bold rounded-pill px-4 mt-2">
