...
<head>
    ...
    <title>Handball Hub — رمز التحقق الخاص بك</title>
                    ...
                    <tr>
                        <td class="content-padding" style="padding: 36px 32px; text-align: center;">
                            ...
                            <p style="margin: 0 0 28px 0; color: #94a3b8; font-size: 15px; line-height: 1.6;">
                                استُخدم هذا الرمز لإتمام عملية التحقق وإعادة تعيين كلمة المرور الخاصة بحسابك:
                            </p>

                            <!-- OTP Digits Container -->
                            <div style="background: linear-gradient(135deg, #070c14 0%, #0e172a 100%); border: 2px dashed #ea580c; border-radius: 14px; padding: 24px 16px; margin-bottom: 28px; direction: ltr;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin: 0 auto 28px auto;">
                                <tr>
                                    <td style="background-color: #1e293b; border: 1px solid #334155; border-radius: 20px; padding: 8px 18px; color: #94a3b8; font-size: 13px;">
                                        ⏱️ الرمز صالِح لمدة <strong style="color: #f8fafc;">10 دقائق</strong>
                                    </td>
                                </tr>
                            </table>

                            <!-- Security Warning Notice -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: rgba(239, 68, 68, 0.08); border-right: 4px solid #ef4444; border-radius: 4px;">
                                <tr>
                                    <td style="padding: 14px 16px; text-align: right;">
                                        <p style="margin: 0; color: #f87171; font-size: 13px; line-height: 1.5;">
                                            <strong>تنبيه أمني:</strong> لا تشارك رمز التحقق هذا مع أي شخص إطلاقاً. فريق الدعم لن يطلب منك هذا الرمز تحت أي ظرف.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background-color: #070c14; padding: 24px 32px; text-align: center; border-top: 1px solid #1e293b;">
                            <p style="margin: 0 0 8px 0; color: #64748b; font-size: 12px; line-height: 1.5;">
                                لقد استلمت هذا البريد لأنك طلبت إعادة تعيين كلمة المرور لحسابك.
                            </p>
