            ...
            <div class="competitions-grid">
                @forelse($competitions ?? [] as $competition)
                    <a href="{{ route('competitions.show', $competition->id) }}" class="competition-card">
                        ...
                        <p class="competition-meta">{{ $competition->season ?? 'N/A' }} &middot;
                            {{ $competition->venue ?? 'N/A' }}</p>
        ...
        <div class="container">
            ...
            <div class="matches-container">
                @forelse($upcomingMatches ?? [] as $match)
                    <div class="match-row">
                        <div class="match-date">{{ $match->scheduled_at->format('D d M, H:i') }}</div>
                        <div class="match-teams">
                            <span class="match-team home">{{ $match->homeTeam->name ?? 'N/A' }}</span>
                            <span class="vs">VS</span>
                            <span class="match-team away">{{ $match->awayTeam->name ?? 'N/A' }}</span>
                        </div>
                        <div class="match-venue">{{ $match->venue ?? 'N/A' }}</div>
                    </div>
                @empty
