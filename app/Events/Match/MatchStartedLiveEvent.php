...
class MatchStartedLiveEvent implements ShouldBroadcastNow
{
    ...
    public function __construct(GameMatch $match)
    {
        ...
        $this->matchData = [
            ...
            'competition_name' => $match->competition?->name ?? 'Handball Competition',
            ...
            'update_score_url' => route('admin.matches.update-score', $match->id),
            'show_url' => route('admin.matches.show', $match->id),
        ];
    }
